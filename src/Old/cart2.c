 ...
 * This is version cart2, which uses a 2nd-order integrator instead of the
 * default 4th-order one.
 *
...
double **vxt[3];       // x-velocity at time t
double **vyt[3];       // y-velocity at time t
